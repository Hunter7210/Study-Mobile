...
import 'package:sa3_correcao_a/controller/db_sqlite.dart';
import 'package:sa3_correcao_a/model/usuario.dart';
import 'package:sa3_correcao_a/view/cadastro_page.dart';
import 'package:sa3_correcao_a/view/home_page.dart';
...
//Metodo
  void _login() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        if (await bancoDados.existsEmail(email) ?? false) {
